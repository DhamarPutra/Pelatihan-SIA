<?php
/**
 * Mata Kuliah Management Page
 * 
 * Helper for managing courses (CRUD).
 * Supports adding, editing, and deleting course data.
 * 
 * @package Admin
 */
...
/**
 * @var mysqli_result $result Result set of all courses
 */
